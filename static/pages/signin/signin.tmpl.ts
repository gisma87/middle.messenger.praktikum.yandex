export const signinTmpl: string = `<main class="main">
<div class="login-container">
  <form id="signinForm" class="form" name=<%-formName%> novalidate>
      ...
      <div class="form__buttons">
        <%=button%>
        <a href="./login" class="form__link form__link_login">Войти</a>
      </div>
    </form>
</div></main>`;
